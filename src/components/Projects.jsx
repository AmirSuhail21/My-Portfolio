const projects = [
  ...
  },
  {
    ...
    description:
      "A real-time Weather Application featuring instant global city search, comprehensive atmospheric data tracking (feels like, high/low limits), dynamic responsive card layouts, and live semantic condition insights.",
    tech: ["React", "Vite", "Material-UI", "REST API", "CSS"],
    link: "https://amirsuhail21.github.io/Weather-App/",
  }
];
